                ...
                <div class="input">
                    <form class="layui-form">
                        ...
                        <div class="layui-form-item x-login-box">
	                        ...
	                        <div class="layui-form-item" id="registerbtn" style="margin-top: 30px;">
	                            <a  class="layui-btn" lay-filter="save"  style="line-height: 67px;height: 67px;" href="${basePath}/jsp/login.jsp">
	                     			  注册
	                            </a>
	                        </div>
