...
<body>
        <div class="x-body">
            <form class="layui-form"  items="${tasks}">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="lmsStationId" name="lmsCustomerId" required lay-verify="required"
                               autocomplete="off" value="${tasks.lmsStationId}" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
        ...
        <script>
            ...
            function edit() {
                $.ajax({
                    type: "POST",
                    url: "/DispatchAdmin/updateTaskSub",
                    data: {
                        id: $('#id').val(),
                        status: $('#status').val(),/*option[index].  */
                        datetime: $('#datetime').val(),
                        type: $('#type').val(),
                        lmsOrderId: $('#lmsOrderId').val(),
                        lmsCustomerId: $('#lmsCustomerId').val(),
                        lmsStationId: $('#lmsStationId').val(),
                        lmsStationRepetoryId: $('#lmsStationRepetoryId').val(),
                        lmsDeliveryStaffId: $('#lmsDeliveryStaffId').val(),
                        satisfy: $('#satisfy').val(),
                    ...
                    error: function () {
                        ...
                        window.parent.location="/DispatchAdmin/queryTask";
                    },
                    success: function () {
                        window.parent.location.reload();
                        window.parent.location="/DispatchAdmin/queryTask";
