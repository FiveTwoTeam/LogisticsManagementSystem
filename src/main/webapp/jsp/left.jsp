        ...
        <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="/service/queryCustom">
                            <cite>客户管理</cite>
                        </a>
                    </dd>
                </dl>
                <dl class="layui-nav-child">
                    ...
                    <dd class="">
                        <a href="javascript:;" _href="/service/queryOrder">
                            <cite>订单管理</cite>
                        </a>
                    </dd>
                </dl>
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="/service/queryOrderBack">
                            <cite>退订查询</cite>
                        </a>
                    </dd>
                </dl>
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="/service/queryProductExchange">
                            <cite>换货查询</cite>
                        </a>
                    </dd>
                </dl>
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="/service/queryOrderProductBack">
                            <cite>退货查询</cite>
                        </a>
                    </dd>
                </dl>
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="/service/queryRepertory">
                            <cite>中心库房查询</cite>
                        </a>
                    </dd>
                </dl>
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="${ basePath }/DispatchAdmin/queryOrder">
                            <cite>订单调度</cite>
                        </a>
                    </dd>
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="${ basePath }/StationRepetoryAdmin/queryProductExport">
                            <cite>出库单</cite>
                        </a>
                    </dd>
                </dl>
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="/Dispatching/queryProduct">
                            <cite>商品管理</cite>
                        </a>
                    </dd>
                </dl>
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="${ basePath }/stationManage/queryTask">
                            <cite>配送任务单</cite>
                        </a>
                    </dd>
                </dl>
                <dl class="layui-nav-child">
                    <dd class="">
                        <a href="javascript:;" _href="${ basePath }/stationManage/queryReceipt">
                            <cite>发票</cite>
                        </a>
                    </dd>
                </dl>
