...
<body ng-app="orderApp">
	<div class="layui-layout layui-layout-order" ng-controller="orderController">
		...
		<div class="x-body">
			...
			<button class="layui-btn" ng-click="order_add('添加用户','${basePath}/jsp/order_add.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加
			</button>
			...
			<tr ng-repeat="order in orders| filter:{'lmsordererId':lmsordererId}">
					...
					<td>{{order.orderNumber}}</td> <%--lmsOrderId--%>
				<td>
	...
	<script type="text/javascript">
        ...
        app.controller('orderController', function ($scope) {
            ...
            $scope.order_edit = function(title,id,w,h) {
                x_admin_show(title,'/DispatchAdmin/updateOrder/'+id,w,h);
            }
