...
<body>
            ...
            <form class="layui-form" items="${products}">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="name" required="" lay-verify="phone"
                               autocomplete="off" class="layui-input" value="${products.name}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="price" name="price" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.price}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="unit" name="unit" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.unit}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="lmsSecondCategoryId" name="lmsSecondCategoryId" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.lmsSecondCategoryId}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="discount" name="discount" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.discount}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="cost" name="cost" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.cost}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="size" id="size" name="unit" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.size}">
                    </div>
                ...
                <div class="layui-input-inline">
                    <input type="text" id="lmsSupplierId" name="lmsSupplierId" required="" lay-verify="email"
                           autocomplete="off" class="layui-input" value="${products.lmsSupplierId}">
                </div>
            </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="qualityPeriod" name="qualityPeriod" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.qualityPeriod}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="idBack" name="idBack" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.ifBack}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="ifExchange" name="ifExchange" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.ifExchange}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="description" name="description" required="" lay-verify="email"
                               autocomplete="off" class="layui-input" value="${products.description}">
                    </div>
                </div>
        ...
        <script>
            ...
            function update() {
                $.ajax({
                    type: "POST",
                    url: "/Dispatching/updateProductSub",
                    data: {
                        id: $('#id').val(),
                        name: $('#name').val(),
                        price: $('#price').val(),
