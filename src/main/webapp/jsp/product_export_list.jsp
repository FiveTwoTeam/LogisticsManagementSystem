...
<body ng-app="productExportApp">
	<div class="layui-layout layui-layout-productExport" ng-controller="productExportController">
		...
		<div class="x-body">
			...
			<button class="layui-btn" onclick="productExport_add('添加用户','${pageContext.request.contextPath}/jsp/produt_export_add.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加
			</button>
			<table class="layui-table">
				...
				<tr ng-repeat="productExport in productExports| filter:{'transport':transport}">
					...
					<td>
						<a title="编辑" href="${pageContext.request.contextPath}/updateProductExport"
...
<script>
    ...
    function productExport_add(title,url,w,h){
        x_productExport_show(title,url,w,h);
    }

    //编辑
    function productExport_edit (title,url,id,w,h) {
        x_productExport_show(title,url,w,h);
    }
	/*删除*/
