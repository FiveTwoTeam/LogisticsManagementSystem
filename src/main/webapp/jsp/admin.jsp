...
<%--<a href="${basePath}/jsp/admin_list.jsp">a</a>--%>
<%--<script src="${basePath}/js/augularjs.js"></script>--%>
...
<div class="layui-layout layui-layout-admin" ng-controller="adminController">
    ...
    <div class="x-body">
        ...
        <button class="layui-btn" onclick="admin_add('添加用户','admin_add.html','600','500')"><i class="layui-icon">&#xe608;</i>添加
        </button>
        <table class="layui-table">
            ...
            <tr ng-repeat="admin in admins| filter:{'username':username}">
                ...
                <td>
                    ...
                    <a title="编辑" href="javascript:;" onclick="admin_edit('编辑','admin_edit.html','4','','510')"
